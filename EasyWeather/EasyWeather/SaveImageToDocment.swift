...
class SaveImageToDocment: NSObject {
    ...
    func getDocumentPath() -> String {
        //沙盒目录
        let urlForDocument = NSFileManager.defaultManager().URLsForDirectory(NSSearchPathDirectory.DocumentDirectory, inDomains:NSSearchPathDomainMask.UserDomainMask)
        //获得沙盒url
